...
class FacebookMixin(OAuthMixin):
    ...
    def _facebook_api_key(self):
        return config.facebook_api_key
    ...
    def authenticate_redirect(self, callback_uri=None, cancel_uri=None,
        ...
        callback_uri = callback_uri or config.facebook_redirect_url
        args = {
        ...
        from plugin.facebookoauth.facebook_auth import OAUTH_ACCESS_TOKEN_COOKIE
        self.set_cookie(OAUTH_ACCESS_TOKEN_COOKIE, self._facebook_api_key)

        a = self.redirect('http://www.facebook.com/login.php?' +
