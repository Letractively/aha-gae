...
from application.controller import BlogBase
...
class BlogContentBase(ModelCRUDController):
    ...
    def set_common_headers(self):
        ...
        """
        set_common_headers(self.content, self.response.headers, EXPIRE_DELTA)
...
class BlogContainerBase(ContainerBase):
    ...
    def set_common_headers(self):
        ...
        A method to set common headers such as expires etc.
        """
        set_common_headers(self.response.headers, EXPIRE_DELTA)
